...
namespace CalculatorTesting
{
    ...
    public class ScientificCalculatorTest : TestBase
    {
        ...
        {
            scientificCalculator.MathOperation(numberOne, symbol, numberTwo);
        ...
        {
            scientificCalculator.FindNumberFromSine(number);
        ...
        {
            scientificCalculator.FindNumberFromCosine(number);
            scientificCalculator.AssertCalculateResult(expectedResult);
        }
